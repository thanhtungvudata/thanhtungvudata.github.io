...
🔽 Denominator: It represents the combined uncertainty in estimating that total variance, based on the degrees of freedom of each variance estimate of each group.
