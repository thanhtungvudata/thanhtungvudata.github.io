...
The answer is yes — but you need to switch tools. In this post, we'll dive into how to perform A/B testing using the t-test, and why it's the right approach when your data is limited.
...
Suppose: 
- $$\mu_A$$ is the true average time on page in A
- $$\mu_B$$ is the true average time on page in B
...
⚙️ Step 2: Estimated Standard Error (SE) Under $$H_0$$ (for equal variances)
