...
The workflow for A/B testing with MWU-test is similar to that for A/B testing with z-test. You can find the workflow in my previous [post](https://thanhtungvudata.github.io/data%20science%20fundamentals/AB-testing/).
